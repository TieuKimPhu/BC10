...
function addUser(){
    console.log("Đây là addUser đã làm xong của kimphu2");
}
...
function suaSinhVien(maSV)
{
    ...
    //Dom tới các thẻ input show thông tin ra value
...
getEle("btnReset").addEventListener("click", function() {
    ...
    //Dom tới các thẻ div  show Err reset ban đầu
});
